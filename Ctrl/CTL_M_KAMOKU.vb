...
Namespace Ctrl
    Public Class CTL_M_KAMOKU

        Public Shared Function GetData() As DS_M_KAMOKU.M_KAMOKUDataTable

            Dim lDt As New DS_M_KAMOKU.M_KAMOKUDataTable
            Dim lEty As New Ety_M_KAMOKU
            ...
            Return lDt
        End Function
        Public Shared Function SelectData(ByVal code As String) As DS_M_KAMOKU.M_KAMOKUDataTable
        ...
        Public Shared Function ExistData(ByVal code As String) As Boolean
            ...
            Dim lDt As New DS_M_KAMOKU.M_KAMOKUDataTable
            Dim lEty As New Enty.Ety_M_KAMOKU
        ...
        Public Shared Function Insert(ByRef lData As DS_M_KAMOKU.M_KAMOKUDataTable) As Boolean
            ...
            Try
                ...
                exist = CTL_M_KAMOKU.ExistData(lData(0).KAMOKU_CD)
        ...
        Public Shared Function UpDate(ByRef lData As DS_M_KAMOKU.M_KAMOKUDataTable) As Boolean
        ...
        Public Shared Function Delete(ByRef code As String) As Boolean
            ...
            Try
                ...
                Using lDb As New SqlConnection(Uty_Config.ConnectionString("keihiSQL"))
                    ...
                    '存在チェック
                    exist = CTL_M_KAMOKU.ExistData(code)
