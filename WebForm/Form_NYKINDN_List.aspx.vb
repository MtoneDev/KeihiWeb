...
Public Class Form_NYKINDN_List
    Inherits System.Web.UI.Page
    '入金フラグ
    Public SLIPFLG As String = "1"
    Public shaincd As String = ""
    Public shainnm As String = ""
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            shainnm = Request.QueryString("shainnm")
            ...
            'GridView_DispSelect(auth_user_id.Text, shiharai, h_date_from.Text, h_date_to.Text)
            'GridView_DispSelect2(auth_user_id.Text, shiharai, h_date_from.Text, h_date_to.Text)
    ...
    Protected Sub Button_Disp_Click(sender As Object, e As EventArgs) Handles Button_Disp.Click
        Try
            ...
            h_shainname.Text = Request.Form("d_user_name")
            ...
            If Not IsNothing(gyowk) And gyowk <> "" Then
                ...
                ldt = Ctrl.CTL_PAYMENT.SelectData_List(lparam, "1")


                Dim url As String = ""
                url = url + "Form_NYKINDN_New.aspx?manageno=" & manage_no + "&jibumoncd=" + jibumon_cd + "&slipno=" + slip_no + "&inputdate=" + input_date + "&disp=" + dispwk + "&userid=" + ldt(0).EMP_CD
                url = url + "&username=" + ldt(0).EMP_NM + "&input_date1=" + input_date1.Text + "&input_date2=" + input_date2.Text
                url = url + "&shiharai=" + d_shiharai.Text + "&shaincd=" + h_shaincd.Text + "&shainnm=" + h_shainname.Text
