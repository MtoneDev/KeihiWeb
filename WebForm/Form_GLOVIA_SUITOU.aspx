<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Form_GLOVIA_SUITOU.aspx.vb" Inherits="KeihiWeb.From_GLOVIA_SUITOU" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btnExec').click(function () {
                ...
                // 処理中メッセージ表示
                $.blockUI({
                    message: '<div><img src="/Content/image/indicator.gif" style="margin-right:5px;">GLOVIAファイルを生成しています。</div>',
                    css: {
                        padding: '25px'
                    }
                });
                ...
                $.ajax({
                    type: "POST",
                    url: "Form_GLOVIA_SUITOU.aspx/CreateGloviaFile",
    ...
    <div id="Container">
        ...
        <div class="body">
            <div class="groupbox">
                ...
                <asp:RadioButton ID="radio15" runat="server" GroupName="KIKAN" Text="15日" Enabled="false" />
                <asp:RadioButton ID="radio31" runat="server" GroupName="KIKAN" text="末日" Enabled="false" />
                <h4>締日：</h4>
