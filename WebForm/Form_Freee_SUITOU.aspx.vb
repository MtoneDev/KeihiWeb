...
Public Class Form_Freee_SUITOU
    ...
    Public Shared Function CreateFreeeFile(ByVal vParam As String) As String
        Try
            ...
            'GLOVIA出力処理
            Dim lPath As String = CTL_GLOVIA.CreateSuitoFile_freee(lBumonList, lParam(0))
            Dim lFilename As String = Uty_File.GetFilename(lPath)
            lRstMsg.AppendLine("<br /><a href='../" & Uty_Config.OutputDir & "/" & lPath.Substring(lPath.LastIndexOf("\" & lBumonList(0) & "\") + 1) & "'>FREEEファイル現金出納帳 (" & lFilename & ")</a>")
