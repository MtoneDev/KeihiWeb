<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Form_GLOVIA_SEIKYU.aspx.vb" Inherits="KeihiWeb.Form_GLOVIA_SEIKYU" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btnExec').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Form_GLOVIA_SEIKYU.aspx/CreateGloviaFile",
