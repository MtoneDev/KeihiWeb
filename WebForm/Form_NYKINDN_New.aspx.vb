    ...
    Private Sub btnClose_Click(sender As Object, e As EventArgs) Handles btnClose.Click
        Try
            ...
            Else
                ...
                'url = url + "Form_NYKINDN_List.aspx?disp=" & disp
                url = url + "Form_NYKINDN_List.aspx?disp=" & disp & "&input_date1=" + input_date1 + "&input_date2=" + input_date2
                url = url + "&shaincd=" + shaincd + "&shiharai=" + shiharai + "&shainnm=" + shainnm
