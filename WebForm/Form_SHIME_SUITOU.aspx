<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Form_SHIME_SUITOU.aspx.vb" Inherits="KeihiWeb.Form_SHIME_SUITOU" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=btnExec.ClientID%>').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Form_SHIME_SUITOU.aspx/ExecShime",
