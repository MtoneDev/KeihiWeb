<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Form_Freee_SUITOU.aspx.vb" Inherits="KeihiWeb.Form_Freee_SUITOU" %>
  ...
  <script type="text/javascript">
        $(function () {
            $('#btnExec').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Form_Freee_SUITOU.aspx/CreateFreeeFile",
