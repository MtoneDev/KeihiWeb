<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Form_SYKINDN_New.aspx.vb" Inherits="KeihiWeb.Form_SYKINDN_New" %>
...
<div>
<label id="lable_shih">支払先</label><input type="text" class="input-sm" id="d_shiharai" style="font-size:smaller  ;margin-left:5px;margin-top:10px;width:500px" />
</div>
    <div>
